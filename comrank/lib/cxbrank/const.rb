module CxbRank
	...
	SP_GAUGE_SURVIVAL = 1
	SP_GAUGE_SURVIVAL_NAME = 'SURV'
	SP_GAUGE_ULTIMATE = 2
	SP_GAUGE_ULTIMATE_NAME = 'ULT'
	...
	SP_GAUGES = {
		...
		MODE_REV => {
			SP_GAUGE_NORMAL       => SP_GAUGE_NORMAL_NAME, 
			SP_GAUGE_SURVIVAL     => SP_GAUGE_SURVIVAL_NAME, 
			SP_GAUGE_ULTIMATE     => SP_GAUGE_ULTIMATE_NAME, 
		}
	}
	...
	RATE_FIGURE = 3             # 達成率入力の最大桁数（0～100）
	...
	SKILL_ERRORS = {
		MUSIC_DIFF_ESY => {
			ERROR_RP_AND_RATE_NOT_EXIST    => ERROR_ESY_RP_AND_RATE_NOT_EXIST,
			ERROR_RP_NOT_NUMERIC           => ERROR_ESY_RP_NOT_NUMERIC,
			ERROR_RP_OUT_OF_RANGE          => ERROR_ESY_RP_OUT_OF_RANGE,
			ERROR_RATE_NOT_NUMERIC         => ERROR_ESY_RATE_NOT_NUMERIC,
			ERROR_RATE_OUT_OF_RANGE        => ERROR_ESY_RATE_OUT_OF_RANGE,
		},
		MUSIC_DIFF_STD => {
			ERROR_RP_AND_RATE_NOT_EXIST    => ERROR_STD_RP_AND_RATE_NOT_EXIST,
			ERROR_RP_NOT_NUMERIC           => ERROR_STD_RP_NOT_NUMERIC,
			ERROR_RP_OUT_OF_RANGE          => ERROR_STD_RP_OUT_OF_RANGE,
			ERROR_RATE_NOT_NUMERIC         => ERROR_STD_RATE_NOT_NUMERIC,
			ERROR_RATE_OUT_OF_RANGE        => ERROR_STD_RATE_OUT_OF_RANGE,
		},
		MUSIC_DIFF_HRD => {
			ERROR_RP_AND_RATE_NOT_EXIST    => ERROR_HRD_RP_AND_RATE_NOT_EXIST,
			ERROR_RP_NOT_NUMERIC           => ERROR_HRD_RP_NOT_NUMERIC,
			ERROR_RP_OUT_OF_RANGE          => ERROR_HRD_RP_OUT_OF_RANGE,
			ERROR_RATE_NOT_NUMERIC         => ERROR_HRD_RATE_NOT_NUMERIC,
			ERROR_RATE_OUT_OF_RANGE        => ERROR_HRD_RATE_OUT_OF_RANGE,
		},
		MUSIC_DIFF_MAS => {
			ERROR_RP_AND_RATE_NOT_EXIST    => ERROR_MAS_RP_AND_RATE_NOT_EXIST,
			ERROR_RP_NOT_NUMERIC           => ERROR_MAS_RP_NOT_NUMERIC,
			ERROR_RP_OUT_OF_RANGE          => ERROR_MAS_RP_OUT_OF_RANGE,
			ERROR_RATE_NOT_NUMERIC         => ERROR_MAS_RATE_NOT_NUMERIC,
			ERROR_RATE_OUT_OF_RANGE        => ERROR_MAS_RATE_OUT_OF_RANGE,
		},
		MUSIC_DIFF_UNL => {
			ERROR_RP_AND_RATE_NOT_EXIST    => ERROR_UNL_RP_AND_RATE_NOT_EXIST,
			ERROR_RP_NOT_NUMERIC           => ERROR_UNL_RP_NOT_NUMERIC,
			ERROR_RP_OUT_OF_RANGE          => ERROR_UNL_RP_OUT_OF_RANGE,
			ERROR_RATE_NOT_NUMERIC         => ERROR_UNL_RATE_NOT_NUMERIC,
			ERROR_RATE_OUT_OF_RANGE        => ERROR_UNL_RATE_OUT_OF_RANGE,
		},
	}
end
